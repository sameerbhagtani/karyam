...
const CAMERA_POSITION: [number, number, number] = [0, 0, 44]
const MODEL_WIDTH_FILL = 0.5
const MODEL_HEIGHT_FILL = 0.42

interface ConchModelViewerProps {
  className?: string
}

export default function ConchModelViewer({ className = '' }: ConchModelViewerProps) {
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        model.traverse((object) => {
          ...
          ;(object as THREE.Mesh).material = whiteMaterial
        })
